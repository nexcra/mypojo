...
public class CopyOfOracleSql extends AbstractSql implements Iterable{

	public static CopyOfOracleSql instance(ip,sid,id,pass){
		CopyOfOracleSql oracleSql = new CopyOfOracleSql()
	...
	public static CopyOfOracleSql instance(url,id,pass){
		CopyOfOracleSql oracleSql = new CopyOfOracleSql()
	...
	public CopyOfOracleSql loadInfo(where=''){
