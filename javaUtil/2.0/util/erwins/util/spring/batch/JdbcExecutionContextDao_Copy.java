 ...
 * serializeContext , ExecutionContextStringSerializer 를 protected 로 변경
 * @author sin
 */
public class JdbcExecutionContextDao_Copy extends AbstractJdbcBatchMetadataDao implements ExecutionContextDao {
	...
	protected ExecutionContextStringSerializer serializer;
