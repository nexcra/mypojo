...
public abstract class AbstractHttpSessionListener  implements HttpSessionListener{
    ...
    /** 초기화에 사용 */
	public static synchronized void setCumulatedSessionCount(long cumulatedSessionCount) {
		AbstractHttpSessionListener.cumulatedSessionCount = cumulatedSessionCount;
	}
