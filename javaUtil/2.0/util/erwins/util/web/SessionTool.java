...
public class SessionTool<USER>{
    ...
    public int[] getInterval(){
        ...
        return DayUtil.betweenTime(lastAccessTime.getTime(), Calendar.getInstance().getTime());
    }
    ...
    public int[] getDuration() {
        ...
        return DayUtil.betweenTime(createTime.getTime(),lastAccessTime.getTime());
    }
    ...
    public String getLastAccessedTimeStr(){
        return DayUtil.DATE.get(getLastAccessedTime());
    }
    public String getCreationTimeStr(){
        return DayUtil.DATE.get(getCreationTime());
    }
