 ...
 */
public class CopyOfTextFileReader{
    ...
    public CopyOfTextFileReader(){}
    public CopyOfTextFileReader(String lineSeparator){this.lineSeparator = lineSeparator;}
    ...
    public static void scan(File folder,StringCallback callback){
        ...
        while(i.hasNext()){
            ...
            new CopyOfTextFileReader().read(file,callback);
        }
    }
