...
public class TextScanner{
    ...
    public TextScanner visit(File folder) {
        ...
        while(i.hasNext()){
            ...
            final String ext = Strings.getExtention(file.getName());
            if(!Strings.isEqualsIgnoreCase(ext, "java")) continue;
            if(Strings.isMatchIgnoreCase(file.getName(),"test")) continue;
