package erwins.openApi{
	...
	public class NaverMapHelper{
		...
		/** 3. 초기화~ ㄱㄱ */
		public function defaultBuild(afterInit:Function,chooseMap:Boolean=true,zoomControllAble:Boolean=true):void{
		    ...
		    _map.addEventListener(NMapEvent.INIT, function onMapInitHandler(event:NMapEvent):void{
			    ...
			    _map.setCenterAndZoom(new NLatLng(37.5577608, 126.9772301), 7);
