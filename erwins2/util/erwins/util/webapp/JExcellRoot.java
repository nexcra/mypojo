...
public abstract class JExcellRoot {
	...
	protected final NumberFormat DOUBLE_FORMAT = new NumberFormat("#,###.00");
	protected final NumberFormat INT_FORMAT = new NumberFormat("0");
	protected WritableCellFormat HEADER;
	protected WritableCellFormat BODY;
	protected WritableCellFormat BODY_NUMBER;
	...
	public void addSheet(String title, List<String> list) {
		addSheet(title, list.toArray(new String[list.size()]));
	}
