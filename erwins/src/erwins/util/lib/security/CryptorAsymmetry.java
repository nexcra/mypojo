...
public class CryptorAsymmetry {
	...
	public CryptorAsymmetry(File root) {
		...
		if (privateKeyFile.exists() && publicKeyFile.exists()) {
			privateKey = Files.getObject(privateKeyFile);
			publicKey = Files.getObject(publicKeyFile);
		}
	}
	...
	public void generateKey() {
		try {
			...
			Files.setObject(privateKeyFile, privateKey);
			Files.setObject(publicKeyFile, publicKey);
