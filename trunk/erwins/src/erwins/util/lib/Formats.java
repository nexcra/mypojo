...
public enum Formats {
    ...
    static {
        //((NumberFormat)PERCENT.getFormat()).setMinimumIntegerDigits(3);
        //((NumberFormat)PERCENT.getFormat()).setGroupingUsed(false);
    }
    ...
    public String get(BigDecimal value) {
    ...
    public static String toDate(String yyyyMMdd,String seperator) {
        ...
        else return yyyyMMdd.substring(0,4)+seperator + yyyyMMdd.substring(4,6)+seperator + yyyyMMdd.substring(6,8);
    }
